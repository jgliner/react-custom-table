...
/******/ 	var hotCurrentHash = "03f858552dac4d74ef67"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".column-toggle {\n  position: absolute;\n  right: 25px;\n  text-align: center;\n  background-color: white;\n  z-index: 999;\n  border: 1px solid #E3E7EA;\n}\n.column-toggle-selector {\n  text-align: center;\n  padding: 10px 60px;\n  width: 100%;\n  padding-left: 0;\n}\n.column-toggle-selector-expand {\n  padding: 5px 30px;\n}\n.list-hidden {\n  display: none;\n}\n.list-visible {\n  display: block;\n  text-align: left;\n  padding: 0 50px;\n}\n\n.col-showing:before {\n  content: \"\\2713\";\n  display: block;\n  position: relative;\n  height: 10px;\n  width: 10px;\n  top: 10px;\n  right: 30px;\n}\n.col-hidden:before {\n  content: \"\";\n  display: block;\n  position: relative;\n  height: 10px;\n  width: 10px;\n  top: 10px;\n  right: 30px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortableTableColumnToggle = __webpack_require__(139);

	var _SortableTableColumnToggle2 = _interopRequireDefault(_SortableTableColumnToggle);
	...
	var SortableTable = function (_React$Component) {
	  ...
	  function SortableTable(props) {
	    ...
	    _this.sortByColumn = _this.sortByColumn.bind(_this);
	    _this.selectColumn = _this.selectColumn.bind(_this);
	    _this.showOrHideList = _this.showOrHideList.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(SortableTable, [{
	    ...
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      var listChanged = this.state.colCount !== nextState.colCount;
	      var listClicked = this.state.listHidden !== nextState.listHidden;
	      var listSorted = this.state.sortOnCol !== nextState.sortOnCol;
	      var listDirChanged = this.state.asc !== nextState.asc;
	    ...
	    key: "selectColumn",
	    value: function selectColumn(colNumber) {
	      var selected = this.state.selected;
	      var selectedLen = this.state.selected.length;
	    ...
	    key: "showOrHideList",
	    value: function showOrHideList(e) {
	      e.stopPropagation();
	      console.log(e.target.parentNode.parentNode);
	      var listState = this.state.listHidden;
	      this.setState({
	    ...
	    value: function sortByColumn(e) {
	      var prevSorted = document.getElementsByClassName("sort-" + this.state.prevOrder)[0];
	      if (prevSorted) {
	      ...
	      var ascending = this.state.asc;
	      var reOrderedDataTable = (0, _lodash.orderBy)(this.state.tableData.stats, function (o) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "table",
	        { className: "sortable-stats-table" },
	        _react2.default.createElement(
	          "thead",
	          null,
	          _react2.default.createElement(
	            "tr",
	            { className: "column-visibility-selector-row" },
	            _react2.default.createElement(
	              "td",
	              { className: "column-visibility-selector" },
	              _react2.default.createElement(_SortableTableColumnToggle2.default, {
	          ...
	          _react2.default.createElement(
	            ...
	            this.state.tableData.headers.map(function (header, i) {
	              return _this3.state.selected.indexOf(i) === -1 ? _react2.default.createElement(
	                "td",
	                {
	                  key: i,
	                ...
	                _react2.default.createElement(
	                  "button",
	                  {
	                    ...
	                    onClick: _this3.sortByColumn
	                  },
	                  header
	                )
	              ) : _react2.default.createElement("td", { key: i, className: "sortable-stats-header-cell-hidden" });
	            })
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          this.state.tableData.stats.map(function (player, j) {
	            return _react2.default.createElement(
	              ...
	              Object.keys(player).map(function (stat, k) {
	                return _this3.state.selected.indexOf(k) === -1 ? _react2.default.createElement(
	                  "td",
	                  { key: k, className: "sortable-stats-cell sortable-stats-cell-" + k },
	                  player[stat]
	                ) : _react2.default.createElement("td", { key: k, className: "sortable-stats-cell-hidden" });
	              })
	            );
	          })
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SortableTableColumnToggle(props) {
	  var showOrHideList = props.showOrHideList,
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      "div",
	      { className: "column-toggle-selector" },
	      _react2.default.createElement(
	        "div",
	        {
	      ...
	      _react2.default.createElement(
	        "div",
	        { className: listHidden ? 'list-hidden' : 'list-visible' },
	        columnHeaders.map(function (item, i) {
	          return _react2.default.createElement(
	            "div",
	            {
	              key: i,
	...
	exports.default = SortableTableColumnToggle;
